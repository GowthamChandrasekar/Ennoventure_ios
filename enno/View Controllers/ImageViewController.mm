...
//    self.optionsView = [[OptionsTableView alloc] initWithFrame:containerView.framestyle:UITableViewStyleGrouped
...
- (void) updateImageView
{
    ...
    {
        NSString *resultSTR = @"";
        self.imageView.image = [self.currentSample processFrame:currentImage result:&resultSTR];
        NSLog(@"ImageVC-->%@", resultSTR);
